...
#include <iostream>
using namespace std;
/*funcion que valida si el nombre solo tiene letras
falta mejorarla creando un ciclo*/
//falta mejorar el trycatch para que no se rompa ya que use
//una plantilla
...
void Tablero::configurarJugadores() {
    try {
        ...
        if (!soloLetras(nombreJugador1)) {
            throw invalid_argument("El nombre solo debe contener letras.");
        }
